...
| Offline 200-record history | Advertised but persistence trigger unresolved | **Disabled** |
| History delete/ack | Command known, test record unavailable | **Disabled** |
| OTA | Capability present, transport not fully validated | **Disabled** |
